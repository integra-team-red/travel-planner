...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http    .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/testAuth/1").permitAll()
                        .requestMatchers(HttpMethod.POST, "/testAuth/login").permitAll()
                        .requestMatchers(HttpMethod.GET, "/testAuth/2").authenticated()
                        .requestMatchers(HttpMethod.POST, "/testAuth/3").permitAll()
                        .requestMatchers(HttpMethod.GET, "/testAuth/3").hasRole("admin")
