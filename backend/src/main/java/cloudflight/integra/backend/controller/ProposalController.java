...
public class ProposalController {
    ...
    @Operation(summary = "Add a proposal to the repository", responses = {@ApiResponse(responseCode = "200", description = "Proposal added successfully; returns the added proposal", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProposalDTO.class))), @ApiResponse(responseCode = "5xx", description = "Invalid proposal supplied", content = @Content)
    })
    @PostMapping
    ...
    @Operation(summary = "Get a list of all proposals from the repository", responses = {@ApiResponse(responseCode = "200", description = "All proposals returned successfully", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = ProposalDTO.class)))),
    })
    @GetMapping
    ...
    @Operation(summary = "Get a proposal from the repository", responses = {@ApiResponse(responseCode = "200", description = "Proposal returned successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProposalDTO.class))), @ApiResponse(responseCode = "5xx", description = "Proposal not found", content = @Content)
    })
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Update a proposal's data with the provided proposal", responses = {@ApiResponse(responseCode = "200", description = "Proposal updated successfully; returns the updated proposal", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProposalDTO.class))), @ApiResponse(responseCode = "5xx", description = "Invalid proposal supplied / Proposal not found", content = @Content),
    })
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Delete a proposal from the repository", responses = {@ApiResponse(responseCode = "200", description = "Proposal deleted successfully; returns the deleted proposal", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProposalDTO.class)))
    })
    @DeleteMapping("/{id}")
