...
public class ServiceTests {
    ...
    void getAllPointsOfInterestSortedByNameTest() {
        ...
        PointOfInterest poi1 = new PointOfInterest(1L,
                                                   ...
                                                   city,
                                                   10.0,
                                                   PointOfInterest.PointOfInterestType.MUSEUM);
        PointOfInterest poi2 = new PointOfInterest(2L,
                                                   "Belvedere Park",
                                                   "Desc",
                                                   city,
                                                   15.0,
                                                   PointOfInterest.PointOfInterestType.PARK);
        PointOfInterest poi3 = new PointOfInterest(3L,
                                                   "Zalha",
                                                   "Desc",
                                                   city,
                                                   20.0,
                                                   PointOfInterest.PointOfInterestType.MONUMENT);
        ...
        assertThat(resultAsc.get(0)
                .getName()).isEqualTo("Belvedere Park");
        assertThat(resultAsc.get(1)
                .getName()).isEqualTo("Museum of Science");
        assertThat(resultAsc.get(2)
                .getName()).isEqualTo("Zalha");
        ...
        assertThat(resultDesc.get(0)
                .getName()).isEqualTo("Zalha");
        assertThat(resultDesc.get(1)
                .getName()).isEqualTo("Museum of Science");
        assertThat(resultDesc.get(2)
                .getName()).isEqualTo("Belvedere Park");
    }
    ...
    void getAllPointsOfInterestSortedByPriceTest() {
        ...
        assertThat(resultAsc.get(0)
                .getPrice()).isEqualTo(10.0);
        assertThat(resultAsc.get(1)
                .getPrice()).isEqualTo(15.0);
        assertThat(resultAsc.get(2)
                .getPrice()).isEqualTo(20.0);
