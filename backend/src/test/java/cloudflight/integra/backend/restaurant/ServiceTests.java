...
public class ServiceTests {
    ...
    public void getAllRestaurantsByCuisine() {
        page = new PageImpl<>(List.of(
                new Restaurant().setCuisineType("Romana"), new Restaurant().setCuisineType("Engleza"),
                new Restaurant().setCuisineType("Spaniola"), new Restaurant().setCuisineType("Germana")));
        ...
        assertThat(service.getAllRestaurantsByCuisine(1, 1, "Romana").stream()
